...
//if (place_meeting(x + 1, y, obj_player_spark) || 
//    place_meeting(x - 1, y, obj_player_spark) || 
//    place_meeting(x, y + 1, obj_player_spark) || 
//    place_meeting(x, y - 1, obj_player_spark)) {
...
//		if (obj_player_spark.yprevious > obj_player_spark.y || obj_player_spark.xprevious > obj_player_spark.x)
//		{
